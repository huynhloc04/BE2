...
class FillDraftJob(BaseModel):
    ...
    def as_form(cls, 
                ...
                industries: Optional[List[str]] = Form(None),
                gender: Optional[GenderChoice] = Form(None),
                job_type: Optional[str] = Form(None),
                skills: Optional[List[str]] = Form(None),
                received_job_time: Optional[datetime] = Form(None),
                working_time: Optional[str] = Form(None),
                ...
                yoe: Optional[str] = Form(None),
                num_recruit: Optional[int] = Form(None),
                education: Optional[List[str]] = Form(None),
                language_certificates: Optional[List[str]] = Form(None),
                other_certificates: Optional[List[str]] = Form(None),
                address: Optional[str] = Form(None),
...
class FillDraftResume(BaseModel):
    job_id: Optional[int]
    ...
    @classmethod
    def as_form(cls, 
                job_id: Optional[int] = Form(...),
                avatar: Optional[UploadFile] = File(...),
                cv_file: Optional[UploadFile] = File(...),
                name: Optional[str] = Form(...),
                industry: Optional[Industry] = Form(...),
                level: Optional[Level] = Form(...),
                current_job: Optional[str] = Form(...),
                phone: Optional[str] = Form(...),
                email: Optional[str] = Form(...),
                address: Optional[str] = Form(...),
                descriptions: Optional[Optional[str]] = Form(...),
                city: Optional[str] = Form(...),
                country: Optional[str] = Form(...),
                objectives: Optional[List[str]] = Form(...),
                birthday: Optional[datetime] = Form(...),
